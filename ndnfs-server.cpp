...
int main(int argc, char const *argv[]) {
    ...
    ndnfs::keyChain.reset(
            new ndn::KeyChain(ndn::ptr_lib::make_shared<ndn::IdentityManager>(identityStorage, privateKeyStorage),
                              ndn::ptr_lib::shared_ptr<ndn::NoVerifyPolicyManager>(new ndn::NoVerifyPolicyManager())));
    ...
    identityStorage->addKey(keyName, ndn::KEY_TYPE_RSA,
                            ndn::Blob(DEFAULT_RSA_PUBLIC_KEY_DER, sizeof(DEFAULT_RSA_PUBLIC_KEY_DER)));
